...
CREATE TABLE `course_tags` (
  ...
  `name_tag` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `course_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKjqwlxw962j7q9wdogwnrctc2p` (`course_id`),
  CONSTRAINT `FKjqwlxw962j7q9wdogwnrctc2p` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`)
